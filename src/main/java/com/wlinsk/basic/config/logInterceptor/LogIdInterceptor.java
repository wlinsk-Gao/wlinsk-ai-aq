...
public class LogIdInterceptor implements HandlerInterceptor, Ordered {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        ...
        log.info("request:{}", JSON.toJSONString(logMap, SerializerFeature.DisableCircularReferenceDetect, SerializerFeature.WriteMapNullValue));
        return true;
    }
    @Override
    ...
    private void resultLog(HttpServletRequest request) {
        ...
        // 记录最后的输出日志
        log.info("{}", JSON.toJSONString(logMap, SerializerFeature.DisableCircularReferenceDetect, SerializerFeature.WriteMapNullValue));
    }
